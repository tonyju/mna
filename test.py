...
print np.imag(yseqs[0,1]),';',np.imag(yseqs[0,2]),';',np.imag(yseqs[1,2])
print np.imag(yseqs[0,0]),';',np.imag(yseqs[1,1]),';',np.imag(yseqs[2,2])
print np.real(yseql[0,1]),';',np.real(yseql[0,2]),';',np.real(yseql[1,2])
print np.real(yseql[0,0]),';',np.real(yseql[1,1]),';',np.real(yseql[2,2])
print np.imag(yseql[0,1]),';',np.imag(yseql[0,2]),';',np.imag(yseql[1,2])
print np.imag(yseql[0,0]),';',np.imag(yseql[1,1]),';',np.imag(yseql[2,2])
